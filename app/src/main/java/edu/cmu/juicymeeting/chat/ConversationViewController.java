...
public class ConversationViewController implements View.OnClickListener, LayerChangeEventListener
    ...
    public ConversationViewController(GroupChatActivity ma, LayerClient client) {
        ...
        //Change the layout
        ma.setContentView(R.layout.activity_group_chat);
    ...
    public static String getInitialMessage() {
        return "Hey, everyone! This is your friend, " + GroupChatActivity.getUserID();
    }
    ...
    private void sendButtonClicked() {
        ...
        if (activeConversation == null) {
            ...
            if (activeConversation == null) {
                activeConversation = layerClient.newConversation(GroupChatActivity.getAllParticipants());
            }
        }
    ...
    private void sendMessage(String text) {
        ...
        options.pushNotificationMessage(GroupChatActivity.getUserID() + ": " + text);
        ...
        if (activeConversation == null) {
            ...
            Query query = Query.builder(Conversation.class)
                    .predicate(new Predicate(Conversation.Property.PARTICIPANTS, Predicate
                            .Operator.EQUAL_TO, GroupChatActivity.getAllParticipants()))
